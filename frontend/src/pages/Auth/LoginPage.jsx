...
const AutoRedirect = (role) => {
  ...
  const normalizedRole = String(roleName || "User").toLowerCase();
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        setTimeout(() => navigate(AutoRedirect(res.role)), 1200);
      } catch (err) {
        const msg =
    ...
    <LoginWrapper>
      <LoginCard>
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <SubTitle>
            Đăng nhập <em>để tiếp tục học tập</em>
          </SubTitle>
        </div>
        ...
        >
          ...
          >
            <g>
              <path
                d="M44.5 20H24V28.5H36.7C35.2 33.1 30.9 36.5 25.5 36.5C18.6 36.5 13 30.9 13 24C13 17.1 18.6 11.5 25.5 11.5C28.5 11.5 31.2 12.6 33.2 14.5L39.1 8.6C35.7 5.5 30.9 3.5 25.5 3.5C14.7 3.5 6 12.2 6 23C6 33.8 14.7 42.5 25.5 42.5C35.2 42.5 43.5 34.7 43.5 25C43.5 23.7 43.4 22.4 43.2 21.2L44.5 20Z"
                fill="#FFC107"
              />
              <path
                d="M6 12.2L13.7 18.1C15.9 13.7 20.3 11.5 25.5 11.5C28.5 11.5 31.2 12.6 33.2 14.5L39.1 8.6C35.7 5.5 30.9 3.5 25.5 3.5C18.6 3.5 13 7.9 10.2 13.1L6 12.2Z"
                fill="#FF3D00"
              />
              <path
                d="M25.5 42.5C30.8 42.5 35.3 40.6 38.6 37.6L31.4 31.3C29.5 32.7 27.1 33.5 25.5 33.5C20.2 33.5 15.9 30.1 14.3 25.5L6 26.4C8.8 34.1 16.4 42.5 25.5 42.5Z"
                fill="#4CAF50"
              />
              <path
                d="M44.5 20H24V28.5H36.7C36 30.6 34.7 32.4 33 33.7L40.2 39.9C43.7 36.7 46 31.7 46 25C46 23.7 45.9 22.4 45.7 21.2L44.5 20Z"
                fill="#1976D2"
              />
            </g>
          </svg>
